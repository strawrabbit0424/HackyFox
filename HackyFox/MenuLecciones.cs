...
namespace HackyFox
{
    public partial class Menu : Form
    {
        ...
        private void btnInfoL1_Click(object sender, EventArgs e)
        {
            Application.Run(new Leccion());
        }

        private void btnRetoL1_Click(object sender, EventArgs e)
        {

        }

        private void btnDinamicaL1_Click(object sender, EventArgs e)
        {
